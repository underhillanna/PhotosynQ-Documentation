...
![(1) Open the citation search box. (2) Enter the DOI number from your citation and press ok. (3) If a citation could be found, the reference is entered at the cursor position.](../images/help/_data_Add_Reference.png)
...
##### NPQ<sub>(T)</sub> - Non Photochemical Quentching
